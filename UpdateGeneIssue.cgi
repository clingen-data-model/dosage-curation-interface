...
dos_group4_param, pmid4_param, pmid4_desc_param = 'dos_group4', 'pmid4', 'pmid4_desc'
dos_group5_param, pmid5_param, pmid5_desc_param = 'dos_group5', 'pmid5', 'pmid5_desc'
dos_group6_param, pmid6_param, pmid6_desc_param = 'dos_group6', 'pmid6', 'pmid6_desc'
...
dos_group4_val = form[dos_group4_param].value if dos_group4_param in form else ''
dos_group5_val = form[dos_group5_param].value if dos_group5_param in form else ''
dos_group6_val = form[dos_group6_param].value if dos_group6_param in form else ''
...
pmid4_val = form[pmid4_param].value if pmid4_param in form else ''
pmid5_val = form[pmid5_param].value if pmid5_param in form else ''
pmid6_val = form[pmid6_param].value if pmid6_param in form else ''
...
pmid4_desc_val = form[pmid4_desc_param].value if pmid4_desc_param in form else ''
pmid5_desc_val = form[pmid5_desc_param].value if pmid5_desc_param in form else ''
pmid6_desc_val = form[pmid6_desc_param].value if pmid6_desc_param in form else ''
...
content += '\nsubmission 4: ' + dos_group4_val + '\n'
content += 'PMID4: ' + pmid4_val + '\n'
content += 'Description PMID4: ' + pmid4_desc_val + '\n'
content += '\nsubmission 5: ' + dos_group5_val + '\n'
content += 'PMID5: ' + pmid5_val + '\n'
content += 'Description PMID5: ' + pmid5_desc_val + '\n'
content += '\nsubmission 6: ' + dos_group6_val + '\n'
content += 'PMID6: ' + pmid6_val + '\n'
content += 'Description PMID6: ' + pmid6_desc_val + '\n'
